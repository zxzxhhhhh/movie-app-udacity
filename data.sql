...
SET @IMAGE_BASE_URL = "https://movies-1256105992.cos.ap-shanghai.myqcloud.com/"; -- FOR EXAMPLE: https://*****.ap-shanghai.myqcloud.com/
...
CREATE TABLE `comment_movie` (
  ...
  `voices` varchar(1023) DEFAULT NULL,
...
--
-- 使用表AUTO_INCREMENT `comment_movie`
--
ALTER TABLE `comment_movie`
...
--
ALTER TABLE `comment_movie`
  ADD CONSTRAINT `comment_movie_link` FOREIGN KEY (`movie_id`) REFERENCES `movies` (`id`);
